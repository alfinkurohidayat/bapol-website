 ...
 function openWhatsApp() {
  const msg1 = document.querySelectorAll('.numbers').textContent;
  const msg2 = document.querySelectorAll('.cardName').textContent;
  const msg3 = document.querySelectorAll('h1').textContent;
