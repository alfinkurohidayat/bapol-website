 ...
 function openWhatsApp() {
  const msg1 = document.querySelector('.numbers').target.textContent;
  const msg2 = document.querySelector('.cardName').target.textContent;
  const msg3 = document.querySelector('h1').target.textContent;
